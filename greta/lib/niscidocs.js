...
(function() {
  var niscidocsApi, niscidocsOperation, niscidocsRequest, niscidocsResource,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  niscidocsApi = (function() {

    niscidocsApi.prototype.discoveryUrl = "http://api.niscidocs.com/v4/resources.json";

    niscidocsApi.prototype.debug = false;

    niscidocsApi.prototype.api_key = null;

    niscidocsApi.prototype.basePath = null;

    function niscidocsApi(options) {
      if (options == null) {
        options = {};
      }
    ...
    niscidocsApi.prototype.build = function() {
      var _this = this;
      ...
      return jQuery.getJSON(this.discoveryUrl, function(response) {
        ...
        if (response.resourcePath != null) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            resource = _ref[_i];
            if (res === null) {
              res = new niscidocsResource(resource, _this);
            } else {
    ...
    niscidocsApi.prototype.selfReflect = function() {
    ...
    niscidocsApi.prototype.fail = function(message) {
      this.failure(message);
      throw message;
    };

    niscidocsApi.prototype.suffixApiKey = function(url) {
      var sep;
    ...
    niscidocsApi.prototype.help = function() {
  ...
  niscidocsResource = (function() {

    function niscidocsResource(resourceObj, api) {
      var parts,
        _this = this;
      this.api = api;
      ...
      if ((resourceObj.operations != null) && (this.api.resourcePath != null)) {
        ...
        if (this.path == null) {
          this.api.fail("niscidocsResources must have a path.");
        }
    ...
    niscidocsResource.prototype.addOperations = function(resource_path, ops) {
      var o, op, _i, _len, _results;
      if (ops) {
        _results = [];
        for (_i = 0, _len = ops.length; _i < _len; _i++) {
          o = ops[_i];
          op = new niscidocsOperation(o.nickname, resource_path, o.httpMethod, o.parameters, o.summary, o.notes, this);
    ...
    niscidocsResource.prototype.help = function() {
    ...
    return niscidocsResource;

  })();

  niscidocsOperation = (function() {

    function niscidocsOperation(nickname, path, httpMethod, parameters, summary, notes, resource) {
      ...
      if (this.nickname == null) {
        this.resource.api.fail("niscidocsOperations must have a nickname.");
      }
      if (this.path == null) {
        this.resource.api.fail("niscidocsOperation " + nickname + " is missing path.");
      }
      if (this.httpMethod == null) {
        this.resource.api.fail("niscidocsOperation " + nickname + " is missing httpMethod.");
      }
    ...
    niscidocsOperation.prototype["do"] = function(args, callback, error) {
      var body, headers;
      if (args == null) {
        args = {};
      }
      ...
      return new niscidocsRequest(this.httpMethod, this.urlify(args), headers, body, callback, error, this);
    };

    niscidocsOperation.prototype.pathJson = function() {
      return this.path.replace("{format}", "json");
    };

    niscidocsOperation.prototype.pathXml = function() {
      return this.path.replace("{format}", "xml");
    };

    niscidocsOperation.prototype.urlify = function(args, includeApiKey) {
    ...
    niscidocsOperation.prototype.supportHeaderParams = function() {
      return this.resource.api.supportHeaderParams;
    };

    niscidocsOperation.prototype.supportedSubmitMethods = function() {
      return this.resource.api.supportedSubmitMethods;
    };

    niscidocsOperation.prototype.getQueryAndHeaderParams = function(args, includeApiKey) {
      if (includeApiKey == null) {
        includeApiKey = true;
      }
    ...
    niscidocsOperation.prototype.getQueryParams = function(args, includeApiKey) {
      if (includeApiKey == null) {
        includeApiKey = true;
      }
    ...
    niscidocsOperation.prototype.getHeaderParams = function(args, includeApiKey) {
      if (includeApiKey == null) {
        includeApiKey = true;
      }
    ...
    niscidocsOperation.prototype.getMatchingParams = function(paramTypes, args, includeApiKey) {
    ...
    niscidocsOperation.prototype.help = function() {
    ...
    return niscidocsOperation;

  })();

  niscidocsRequest = (function() {

    function niscidocsRequest(type, url, headers, body, successCallback, errorCallback, operation) {
      var obj,
        _this = this;
      this.type = type;
      this.url = url;
      ...
      if (this.type == null) {
        throw "niscidocsRequest type is required (get/post/put/delete).";
      }
      if (this.url == null) {
        throw "niscidocsRequest url is required.";
      }
      if (this.successCallback == null) {
        throw "niscidocsRequest successCallback is required.";
      }
      if (this.errorCallback == null) {
        throw "niscidocsRequest error callback is required.";
      }
      if (this.operation == null) {
        throw "niscidocsRequest operation is required.";
      }
    ...
    niscidocsRequest.prototype.asCurl = function() {
      var header_args, k, v;
    ...
    return niscidocsRequest;

  })();

  window.niscidocsApi = niscidocsApi;

  window.niscidocsResource = niscidocsResource;

  window.niscidocsOperation = niscidocsOperation;

  window.niscidocsRequest = niscidocsRequest;
