...
function program5(depth0,data) {
  ...
  return "\n                    <div class='sandbox_header'>\n                        <input class='submit' name='commit' type='button' value='Prova!' />\n                        <a href='#' class='response_hider' style='display:none'>Nascondi Risposta</a>\n                        <img alt='Throbber' class='response_throbber' src='http://students.uniparthenope.it/~0124000074/greta/images/throbber.gif' style='display:none' />\n                    </div>\n                    ";}
  ...
  stack1 = stack2.call(depth0, stack1, tmp1);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                </form>\n                <div class='response' style='display:none'>\n                    <h4>URL Richiesto</h4>\n                    <div class='block request_url'></div>\n                    <h4>Corpo Risposta</h4>\n                    <div class='block response_body'></div>\n                    <h4>Codice Risposta</h4>\n                    <div class='block response_code'></div>\n                    <h4>Intestazione Risposta</h4>\n                    <div class='block response_headers'></div>\n                </div>\n            </div>\n        </li>\n    </ul>\n";
  return buffer;});
})();
...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n        <textarea class='body-textarea'  readonly='readonly' placeholder='(obbligatorio)' name='";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
...
function program2(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n			<textarea class='body-textarea' placeholder='(obbligatorio)' name='";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
...
function program7(depth0,data) {
  ...
  buffer += escapeExpression(stack1) + "' placeholder='(obbligatorio)' type='text' value='";
  foundHelper = helpers.defaultValue;
  stack1 = foundHelper || depth0.defaultValue;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "defaultValue", { hash: {} }); }
...
function program9(depth0,data) {
  //crea le caselle di input dei parametri
  var buffer = "", stack1;
  buffer += "\n		    <input class='required' minlength='1' name='";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  ...
  if(escapeExpression(stack1) == 'password'){buffer += escapeExpression(stack1) + "' placeholder='(obbligatorio)' type='password' value=''/>\n		";}
  else{buffer += escapeExpression(stack1) + "' placeholder='(obbligatorio)' type='text' value=''/>\n		";}
  return buffer;}
...
templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  buffer += escapeExpression(stack1) + "');\">Mostra/Nascondi</a>\n        </li>\n        <li>\n            <a href='#' onclick=\"Docs.collapseOperationsForResource('";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
...
(function() {
  var HeaderView, MainView, OperationView, ParameterView, ResourceView, niscidocsUi,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  niscidocsUi = (function(_super) {

    __extends(niscidocsUi, _super);

    function niscidocsUi() {
      return niscidocsUi.__super__.constructor.apply(this, arguments);
    }

    niscidocsUi.prototype.routes = {
      '': 'load'
    };

    niscidocsUi.prototype.dom_id = "niscidocs_ui";

    niscidocsUi.prototype.options = null;

    niscidocsUi.prototype.api = null;

    niscidocsUi.prototype.headerView = null;

    niscidocsUi.prototype.mainView = null;

    niscidocsUi.prototype.initialize = function(options) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      ...
      return this.headerView.on('update-niscidocs-ui', function(data) {
        return _this.updateniscidocsUi(data);
      });
    };

    niscidocsUi.prototype.updateniscidocsUi = function(data) {
      this.options.discoveryUrl = data.discoveryUrl;
      this.options.apiKey = data.apiKey;
      return this.load();
    };

    niscidocsUi.prototype.load = function() {
      var _ref;
      if ((_ref = this.mainView) != null) {
        _ref.clear();
      }
      this.headerView.update(this.options.discoveryUrl, this.options.apiKey);
      this.api = new niscidocsApi(this.options);
      return Backbone.history.start({
        pushState: true
      });
    };

    niscidocsUi.prototype.render = function() {
      var _this = this;
      this.showMessage('Finished Loading Resource Information. Rendering niscidocs UI...');
    ...
    niscidocsUi.prototype.showMessage = function(data) {
      if (data == null) {
        data = '';
      }
    ...
    niscidocsUi.prototype.onLoadFailure = function(data) {
      if (data == null) {
        data = '';
      }
  ...
  window.niscidocsUi = niscidocsUi;
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.showPetStore = function(e) {
      return this.trigger('update-niscidocs-ui', {
        discoveryUrl: "--/api/resources.json",
        apiKey: "special-key"
      });
    };
