...
main.load = function() {
    var json = {
          "apiVersion": "1.0",
          "basePath": "http://students.uniparthenope.it:PORTA",
          "resourcePath": "",
          "apis": [
            {
              "path": "/action.{format}?username={matricola}&password={password}",
              "description": "descrizione",
              "operations": [
                {
                  "httpMethod": "GET",
                  "summary": "descrizione breve dell'operazione",
                  "notes": "descrizione lunga",
                  "responseClass": "classe",
                  "nickname": "nick unico per l'operazione",
                  "parameters": [
                    {
                      "name": "nome parametro (uguale a quello richiesto dall'api)",
                      "description": "descrizione",
                      "paramType": "path",
                      "required": true,
                      "allowMultiple": false,
